#!/usr/bin/env python3
"""Run scenario S1 and save its outputs (CSV/NPZ/JSON)."""
...
def main():
    ...
    print(f"  outputs -> results/scenarios/S1_*.{{csv,npz,json}}")
    return result
